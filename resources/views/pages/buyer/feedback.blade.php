...
@section('content')
    ...
    <section class="container mx-auto py-10 min-h-[calc(100svh-11em)] px-3 md:px-0">
        ...
        <div class="grid md:grid-cols-2 items-start">
            <form action="{{ route('buyer_add_feedback') }}" method="POST" class="flex justify-center p-3 md:p-10">
                @csrf
                <div class="w-[90%]">
                ...
                <table class="table table-auto border-collapse border w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border p-2 text-paragraph">
                                <a href="{{ route('buyer_delete_feedback', ['id'=>$feedback->id]) }}" class="text-red-500 underline font-medium hover:text-red-300">Delete</a>
                            </td>
                        </tr>
                        @empty
                            <tr>
